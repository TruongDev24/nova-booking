        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input {...register("fullName")} className="w-full pl-10 pr-3 py-2 border rounded-lg" placeholder="Admin Name" />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input type="email" {...register("email")} className="w-full pl-10 pr-3 py-2 border rounded-lg" placeholder="admin@nova.com" />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input {...register("phone")} className="w-full pl-10 pr-3 py-2 border rounded-lg" placeholder="09xxxxxxx" />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input type="password" {...register("password")} className="w-full pl-10 pr-3 py-2 border rounded-lg" placeholder="••••••••" />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <Lock className="absolute left-3 top-3 h-5 w-5 text-slate-400" />
              <input type="password" {...register("confirmPassword")} className="w-full pl-10 pr-3 py-2 border rounded-lg" placeholder="••••••••" />
            </div>
          </div>
