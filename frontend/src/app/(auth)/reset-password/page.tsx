    ...
    if (isSuccess) {
        return (
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-600">Mật khẩu của bạn đã được cập nhật. Đang chuyển hướng về trang đăng
                    nhập...</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                ...
                <div className="p-8">
                    <Suspense fallback={<div className="flex justify-center py-8"><Loader2
                        className="animate-spin w-8 h-8 text-cyan-600"/></div>}>
                        <ResetPasswordForm/>
                    </Suspense>
                </div>
            </div>
