        ...
        <Card className="border-none shadow-sm flex flex-col h-full overflow-hidden">
            ...
            <CardContent className="p-0 flex-1 overflow-hidden">
                <Table>
                                ...
                                <TableRow key={customer.userId} className="group transition-colors">
                                    <TableCell className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div
                                                className="w-7 h-7 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 font-black text-[10px] group-hover:scale-110 transition-transform">
                                                {index + 1}
                                            </div>
                    ...
                    <span
                        className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-muted text-muted-foreground text-[9px] font-black uppercase">
