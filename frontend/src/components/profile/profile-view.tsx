  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-4 md:p-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 md:p-12 text-white shadow-2xl shadow-slate-900/20">
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-cyan-500/20 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px]"></div>
        
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
          <div className="relative">
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-3xl bg-gradient-to-br from-cyan-400 to-indigo-500 p-1.5 shadow-2xl rotate-3">
              <div className="w-full h-full rounded-[1.4rem] bg-slate-900 flex items-center justify-center overflow-hidden -rotate-3">
                <User className="w-16 h-16 md:w-20 md:h-20 text-cyan-400" />
              </div>
            </div>
            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-emerald-500 rounded-2xl border-4 border-slate-900 flex items-center justify-center shadow-lg">
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden bg-white/80 backdrop-blur-xl">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="ml-11">Các thông tin cơ bản liên kết với tài khoản của bạn</CardDescription>
            </CardHeader>
            <CardContent className="pt-6 space-y-6">
              ...
              <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 flex items-start gap-3">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">
                  <strong>Lưu ý:</strong> Để đảm bảo tính xác thực và an toàn, bạn không thể tự thay đổi Email và Số điện thoại. Vui lòng liên hệ hỗ trợ nếu cần cập nhật.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="lg:col-span-2">
          <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden sticky top-8">
            <CardHeader className="bg-slate-900 text-white pb-6 relative overflow-hidden">
              ...
              <CardDescription className="text-slate-400 relative z-10">Cập nhật mật khẩu để bảo vệ tài khoản</CardDescription>
