...
ALTER
COLUMN "description" SET NOT NULL;

-- AlterTable
ALTER TABLE "User"
    ADD COLUMN "avatar" TEXT,
ALTER
COLUMN "fullName" SET NOT NULL,
ALTER
...
-- AddForeignKey
ALTER TABLE "Court"
    ADD CONSTRAINT "Court_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Review"
    ADD CONSTRAINT "Review_courtId_fkey" FOREIGN KEY ("courtId") REFERENCES "Court" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
